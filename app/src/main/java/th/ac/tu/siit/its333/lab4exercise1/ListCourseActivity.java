...
public class ListCourseActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery(
                "SELECT _id, code, (grade || ' ' || '(' || credit || ' credit)' ) g FROM course ORDER BY _id DESC;", null
        );

        adapter = new SimpleCursorAdapter(this, android.R.layout.simple_list_item_2, cursor, new String[] {"code", "g"},
